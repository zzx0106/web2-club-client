<template>
    <div class="login-container">
        ...
        <div class="sub-title-box">
            <div class="sub-title" @click="changeShow()">
        ...
        <Form class="form-container" ref="formValidate" :model="formValidate" :rules="ruleValidate">
            <FormItem prop="name" v-show="show">
                <Row>
                    <Col span="23">
            ...
            <FormItem prop="email" v-show="!show">
                <Row>
                    <Col span="23">
...
<script>
import { Form, FormItem, Button, Input, Slider, iSwitch, CheckboxGroup, Checkbox, Row, Col, Select, Option, DatePicker, Message } from 'iview';
            ...
            try {
                ...
                if (httpkey.msg === 'ok') {
                    ...
                    if (this.show) {
                        ...
                        user = await this.$http.loginByEmail({ email, password }, key);
                    }
                    if (user.msg === 'ok') {
